           ...
           <Card.Body style={{ display: 'flex', justifyContent: 'space-between', textAlign: 'justify' }}>
             <div>
               ...
               <Card.Text className='cardtext'>{user.description}</Card.Text>
                             <Button variant="primary" className="mr-2" onClick={() => setModalShow(true)}>Edit Profile</Button>
...
<EditProfileModal show={modalShow} handleClose={() => handleCloseEditModal} user={user} setUser={setUser} />
     </div>
   );
 };
